...
typedef struct
{
    double n1,                                              /* The number of times the first wire is wrapped around the transformer */
           n2,                                              /* The number of times the second wire is wrapped around the transformer */     
           v1,                                              /* The input voltage value */
           i1;                                              /* The input current value */
} transformer_t;                                            /* Structure of electrical currents in a transformer */
